...
function load_items( t ){
	...
	$.get("/items.json?list="+tab, function(data){
		...
		str+="	  <th>Notes</th>";
		str+="	  <th>Created</th>";
		global_store.current_menu=='Archive' ? str+=("    <th>Completed</th>") : str+=("	  <th>Complete</th>");
		...
		for (i=0; i<results.length; i++ ){
			...
			global_store.current_menu=='Archive' ? "" : str+=("<td class=\"item_row_actions\"><span class=\"glyphicon glyphicon-move\"></span> Done</td>");
...
function load_itemsOLDER(){
	var tab="Next"
	$.ajax({
		url: "/items.json?list="+tab,
